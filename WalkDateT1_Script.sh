...
# Author : Xiejinke                                       #
#                                                         #
# History: 2016-06-23 created                             #
#                                                         #
###########################################################

PROGRAM_HOME="/home/ylx/GoProjects"
MONITOR="$PROGRAM_HOME/bin/WalkDateT1_Script.sh monitor"
...
start()
{
    ...
    then
        ...
        then
            ...
            grep "WalkDateT1_Script.sh monitor" crontab.tmp>/dev/null 2>&1
            if test $? -eq 1
            then
...
stop()
{
    crontab -l | grep -v "WalkDateT1_Script.sh monitor" > crontab.tmp
    crontab crontab.tmp
    rm crontab.tmp
...
usage()
{
    ...
    echo " 查看版本号 $0 about"
    echo " 查看启动情况 $0 list"
    echo " 启动WalkDateT1_Script $0 start"
    echo " 停止WalkDateT1_Script $0 stop"
    echo ""
}
